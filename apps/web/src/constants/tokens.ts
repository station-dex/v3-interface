...
export const USDC_POLYGON_MUMBAI = new Token(
  ...
  '0x6141f0Fe8822361f497F6C6c67AA7763aEd864A9',
  6,
  'USDC',
  'USD Coin'
)
...
export const USDC_X1_TESTNET = new Token(
  ChainId.X1_TESTNET,
  '0x7bBa099eb3050880DBbc1b42eB7Ef8A3Ff1EB248',
  6,
  'USDC',
  'USDC Coin'
)
...
export const WETH_X1_TESTNET = new Token(
  ChainId.X1_TESTNET,
  '0x0F532A02503BcE28444cE6d4ccC163cC1E2e56A6',
  18,
  'WOKB',
  'Wrapped OKB'
)
export const DAI_X1_TESTNET = new Token(
  ChainId.X1_TESTNET,
  '0x510F26d36A6ec83E253737C67E1204E404714fe2',
  18,
  'DAI',
  'DaiStablecoin'
)

export const USDC_X_LAYER_MAINNET = new Token(
  ChainId.X_LAYER_MAINNET,
  '0x74b7f16337b8972027f6196a17a631ac6de26d22',
  6,
  'USDC',
  'USDC Coin'
)
export const USDT_X_LAYER_MAINNET = new Token(
  ChainId.X_LAYER_MAINNET,
...
export const WETH_X_LAYER_MAINNET = new Token(
  ChainId.X_LAYER_MAINNET,
...
export const WBTC_X_LAYER_MAINNET = new Token(
  ChainId.X_LAYER_MAINNET,
...
export const DAI_X_LAYER_MAINNET = new Token(
  ChainId.X_LAYER_MAINNET,
...
export const WRAPPED_NATIVE_CURRENCY: { [chainId: number]: Token | undefined } = {
  ...
  [ChainId.POLYGON_MUMBAI]: new Token(
    ChainId.POLYGON_MUMBAI,
    '0x8425d487c97Fb2464Fbc648F294589bD7B3122d4',
    18,
    'WMATIC',
    'Wrapped MATIC'
  ),
  ...
  [ChainId.X_LAYER_MAINNET]: new Token(
    ChainId.X_LAYER_MAINNET,
...
export function isX1(chainId: number): chainId is ChainId.X1_TESTNET {
  return chainId === ChainId.X1_TESTNET || chainId === ChainId.X_LAYER_MAINNET
}
...
class OkbNativeCurrency extends NativeCurrency {
  equals(other: Currency): boolean {
    return other.isNative && other.chainId === this.chainId
  }

  get wrapped(): Token {
    if (!isX1(this.chainId)) throw new Error('Not avalanche')
    const wrapped = WRAPPED_NATIVE_CURRENCY[this.chainId]
    invariant(wrapped instanceof Token)
    return wrapped
  }
  ...
  public constructor(chainId: number) {
    if (!isX1(chainId)) throw new Error('Not avalanche')
...
export function nativeOnChain(chainId: number): NativeCurrency | Token {
  ...
  } else if (isX1(chainId)) {
    nativeCurrency = new OkbNativeCurrency(chainId)
  } else {
